...
var formatData = function(data) {
	...
	for(var i = 0; i < explans.length; i++) {
		...
		var d = {
			'priid': explans[i].priid,
			'exhistoryNumer': explans[i].exhistoryNumer,
			'exhistoryId': explans[i].exhistoryId,
			'principalname': explans[i].principalname,
			'exdate': explans[i].exdate,
			'extype': explans[i].extype,
			'goodsname': explans[i].goodsname,
			'specificatintype': explans[i].specificatintype,
			'produceenterprise': explans[i].produceenterprise,
			'produceregistrationnumberorrecordcertificatenumber': explans[i].produceregistrationnumberorrecordcertificatenumber,
			'producebatchnumberorserialnumber': explans[i].producebatchnumberorserialnumber,
			'storagetransportationcondition': explans[i].storagetransportationcondition,
			'producedateandvalidity': explans[i].producedateandvalidity,
			'unit': explans[i].unit,
			'quantity': explans[i].quantity,
			'receivingcustomername': explans[i].receivingcustomername,
			'receivingaddress': explans[i].receivingaddress,
