...
<html>
    ...
    <input type="text" class="form-control"placeholder="请输入字段名" / >  
        <span class="input-group-btn">  
            ...
            <button  id="reset" class="btn btn-info btn-search" style="margin-left:3px">重置</button>
            <button id="add" class="btn btn-info" style="margin-left:3px">添加</button>
        </span>  
     </div>  -->
			...
			<div class="modal-dialog" role="document" style="width:1000px">
				<div class="modal-content">
					...
					<div class="modal-body ">
						...
						<!-- <div class="form-group row">
							<div class="col-md-2">	
								<label for="shipperId" >货主序号</label>
							</div>
							<div class="col-md-10">
							<input type="text" name="shipperId" class="form-control " id="shipperId" placeholder="货主序号">
							</div>
						</div> -->
						...
						<!-- <div class="form-group row">
							<div class="col-md-2">	
								<label for="serviceId">客服序号</label>
							</div>
							<div class="col-md-10">
							
								<input type="text" name="serviceId" class="form-control" id="serviceId" placeholder="客服序号">
							</div>
						...
						<!-- <div class="form-group row">
							...
							<div class="col-md-10">
							<select name="storehousename" class="form-control able-delete storehousename" id="storehousename">
							</select>
